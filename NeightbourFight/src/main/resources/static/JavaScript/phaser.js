...
class EscenaLogin1 extends Phaser.Scene {
    constructor() {
        super({ key: 'EscenaLogin1' });
    }

    preload() {
        this.load.image('fondo_juego_eleccion1', 'assets/images/definitivas/general/pantalla_inicio_anciana.png');
        this.load.image('boton_continuar', 'assets/images/definitivas/general/boton_continuar.png');
    }

    create() {
        this.add.image(640, 360, 'fondo_juego_eleccion1');
        this.add.image(640, 600, 'boton_continuar');
        
        var jugar2 = this.add.zone(490, 550, 300, 100);
        jugar2.setOrigin(0);
        jugar2.setInteractive();
        jugar2.once('pointerdown', () => {
            this.scene.start('EscenaLogin2')
        });
        //this.add.graphics().lineStyle(2,0x00ff0c).strokeRectShape(jugar2);
...
class EscenaLogin2 extends Phaser.Scene {
    constructor() {
        super({ key: 'EscenaLogin2' });
    }

    preload() {
        this.load.image('fondo_juego_eleccion2', 'assets/images/definitivas/general/pantalla_inicio_rockero.png');
        this.load.image('boton_continuar2', 'assets/images/definitivas/general/boton_continuar.png');
    }

    create() {
        this.add.image(640, 360, 'fondo_juego_eleccion2');
        this.add.image(640, 600, 'boton_continuar2');

        var jugar3 = this.add.zone(490, 550, 300, 100);
        jugar3.setOrigin(0);
        jugar3.setInteractive();
        jugar3.once('pointerdown', () => {
...
class EscenaInicio extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('boton_creditos', 'assets/images/definitivas/general/boton_creditos.png');
    }
    ...
    create() {
        ...
        this.add.image(640, 325, 'boton_creditos').setScale(0.7);
        ...
        var creditos = this.add.zone(535, 285, 205, 75);
        creditos.setOrigin(0);
...
class EscenaTutorial1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.image(1200, 100, 'atras1');
        this.add.image(1200, 360, 'flecha_derecha');

        var volver1 = this.add.zone(1150, 50, 100, 100);
        volver1.setOrigin(0);
        ...
        var pasarDerecha = this.add.zone(1150, 305, 110, 110);
...
class EscenaTutorial2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.image(1200, 100, 'atras2');
        this.add.image(50, 360, 'flecha_izquierda');

        var volver2 = this.add.zone(1150, 50, 100, 100);
        volver2.setOrigin(0);
        ...
        var pasarIzquierda = this.add.zone(0, 305, 110, 110);
...
class EscenaCreditos extends Phaser.Scene {
    ...
    preload() {
        this.load.image('pantalla_creditos', 'assets/images/definitivas/general/pantalla_creditos.png');
        this.load.image('atras3', 'assets/images/definitivas/general/volver.png');
    }

    create() {
        this.add.image(640, 360, 'pantalla_creditos');
        this.add.image(1200, 100, 'atras3');

        var volver3 = this.add.zone(1150, 50, 100, 100);
        volver3.setOrigin(0);
        volver3.setInteractive();
        volver3.once('pointerdown', () => {
            this.scene.start('EscenaInicio')
        });
        //this.add.graphics().lineStyle(2,0xff0000).strokeRectShape(volver2);
    }
